---
sidebar_position: 3
title: Real-World Message Captures
---

# Comfort Panel with Autoterm 44D (Message Captures)
...
| **`T+2s`** | **C » H** | `AA 03 01 00 11 12 B0 D1` | **`0x11`**: Thermostat Broadcast | Controller broadcasts room temp of 18°C (`12` Hex). |
| **`T+2s`** | **H » C** | `AA 04 01 00 11 12 70 64` | **`0x11`**: Thermostat Confirm | Heater echoes the `12` payload, acknowledging the temperature is 18°C. |
